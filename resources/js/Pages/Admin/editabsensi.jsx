...
export default function editabsensi(props) {
    ...
    const [description, setDescription] = useState(props.allabsensi.description);
    const [start_time, setStart_time] = useState(props.allabsensi.start_time);
    const [batas_start_time, setBatas_start_time] = useState(props.allabsensi.batas_start_time);
    ...
    const updatePosition = async (e) => {
        e.preventDefault();
        //sending data
        Inertia.post(`/updateabsensi/${props.allabsensi.id}`, {
    ...
    return (
        ...
        <AuthenticatedLayout
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Absensi</h2>}
        >
            <Head title="Jabatan" />
            ...
            <div className='flex justify-center'>
                <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <form className="space-y-6" onSubmit={updatePosition}>
                        <h5 className="text-xl font-medium text-gray-900 dark:text-white">Edit Absensi in website</h5>
                        <div>
                            <label type="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name Absensi</label>
                        ...
                        <div>
                            <label type="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
